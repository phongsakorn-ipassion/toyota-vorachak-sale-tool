...
export function leadToRemote(lead) {
  return {
    ...
    converted_from: lead.convertedFrom || null,
    converted_to: lead.convertedTo || null,
...
export function remoteToLead(remote) {
  ...
  return {
    ...
    convertedFrom: remote.converted_from || null,
    convertedTo: remote.converted_to || null,
    activities,
